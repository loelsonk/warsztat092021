import { __values, __read, __assign, __spreadArray } from 'tslib';
import { GraphQLObjectType, GraphQLInterfaceType, GraphQLUnionType, isSpecifiedScalarType, isScalarType, visit, Kind, TypeInfo, visitWithTypeInfo, isObjectType, isInterfaceType, typeFromAST, isInputType, valueFromAST, isLeafType, getNullableType, BREAK, parse, getIntrospectionQuery, buildClientSchema } from 'graphql';
...
import { applySchemaTransforms, isExternalObject, getUnpathedErrors, getSubschema, resolveExternalValue, delegateToSchema, defaultMergedResolver } from '@graphql-tools/delegate/es5';
