...
function generateConfig(filePath, code, _options) {
    ...
    switch (fileExt) {
        ...
        case '.js':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(dynamicFlowPlugins), false));
            break;
        case '.jsx':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(dynamicFlowPlugins), false));
            break;
        case '.flow.js':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(flowPlugins), false));
            break;
        case '.flow.jsx':
            plugins.push.apply(plugins, tslib.__spreadArray(['jsx'], tslib.__read(flowPlugins), false));
            break;
...
const createVisitor = (function (code, out, options) {
    ...
    var _a = tslib.__assign(tslib.__assign({}, defaults), options), _b = _a.modules, modules = _b === void 0 ? [] : _b, globalGqlIdentifierName = _a.globalGqlIdentifierName, gqlMagicComment = _a.gqlMagicComment;
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    code = _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, parseCode({ code: code, filePath: filePath, options: options }).map(function (t) { return new graphql.Source(t.content, filePath, t.loc.start); })];
            }
        });
    });
};
...
var gqlPluckFromCodeStringSync = function (filePath, code, options) {
    ...
    return parseCode({ code: code, filePath: filePath, options: options }).map(function (t) { return new graphql.Source(t.content, filePath, t.loc.start); });
};
